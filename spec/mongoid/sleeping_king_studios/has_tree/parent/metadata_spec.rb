# spec/mongoid/sleeping_king_studios/has_tree/parent/metadata_spec.rb

require 'mongoid/sleeping_king_studios/spec_helper'

require 'mongoid/sleeping_king_studios/has_tree/parent/metadata'

describe Mongoid::SleepingKingStudios::HasTree::Parent::Metadata do
  let(:name)       { :relation }
  let(:properties) { {} }
  ...
  describe '#inverse_of' do
    ...
    specify { expect(instance.inverse_of).to be == :children }
  ...
  describe '#relation_name' do
    ...
    specify { expect(instance.relation_name).to be == :parent }
